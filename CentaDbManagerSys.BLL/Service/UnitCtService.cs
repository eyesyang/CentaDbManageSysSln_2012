...
namespace CentaDbManageSys.BLL
{
    public class UnitCtService
    {
        ...
        private UnitCtDbService _DbService = null;

        public UnitCtService()
        {
            this._DbService = new UnitCtDbService();
        }        
        ...
        public IList<UnitCmType> ListUnitByBuildName(string buildName)
        {
            ...
            try
            {
                DataTable table = _DbService.ListUnitByBuildName(buildName);
        ...
        public bool AddUnit(string buildId, string cx_axis, string cy_axis, string createBy)
        {
            ...
            try
            {
                int effected = _DbService.InsertUnit(buildId, cx_axis, cy_axis, createBy);
                return effected > 0;
            }
            catch (Exception ex)
            {
