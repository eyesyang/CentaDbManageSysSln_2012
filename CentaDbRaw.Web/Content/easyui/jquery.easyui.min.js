...
var tool=$("<a href=\"#\"></a>").appendTo(_1d6);
tool.css("float","left");
...
var _1d8=$("<a href=\"#\"></a>").appendTo(_1d7);
if(p.handler){
...
$("<a></a>").attr("href","#").text(_1f1).css("margin-left",10).bind("click",eval(_1f0[_1f1])).appendTo(tb).linkbutton();
}
}
...
win.window({title:opts.title,modal:opts.modal,width:opts.width,height:opts.height,collapsible:false,minimizable:false,maximizable:false,draggable:false,resizable:false,onBeforeOpen:function(){
...
var tool=$("<a href=\"#\"></a>").appendTo(_248);
...
var _264=$("<a href=\"#\" class=\"tabs-inner\"></a>").appendTo(tab);
...
$("<a href=\"#\" class=\"datebox-current\"></a>").html(opts.currentText).appendTo(_712);
$("<a href=\"#\" class=\"datebox-close\"></a>").html(opts.closeText).appendTo(_712);
...
var ok=$("<a href=\"#\" class=\"datebox-ok\"></a>").html(opts.okText).appendTo(_727);
ok.hover(function(){
$(this).addClass("datebox-button-hover");
},function(){
$(this).removeClass("datebox-button-hover");
